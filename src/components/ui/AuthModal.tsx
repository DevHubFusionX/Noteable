          ...
          <>
            ...
            <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 pointer-events-none">
              ...
              >
                ...
                <button
                  onClick={onClose}
                  className="absolute top-4 right-4 z-[100] w-7 h-7 rounded-lg flex items-center justify-center text-slate-400 hover:text-slate-700 hover:bg-white/80 transition-all"
                >
